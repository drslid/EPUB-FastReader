...
La CI GitHub du commit `7c420c4eb19b6abbb3caddec67fbc17392b19440` a réussi ses contrôles unitaires, ses 288 tests navigateur, le contrôle du relais et les neuf contrôles du build Pages configuré. Le job de publication Pages a ensuite été corrigé pour accepter un déploiement du relais facultatif sauté : il exige explicitement la réussite du build Pages et l’absence d’annulation.
