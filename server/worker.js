 ...
 * by region, reader, browser or deployment; no personal library is stored.
 */
export class FastReaderSources {
  ...
  async dispatch(request) {
    ...
    return await this.gutenberg(request) || await this.ebooksGratuits(request) || await this.fadedpage(request) || await this.epubbooks(request) || await this.ebookzy(request) || await this.loyalbooks(request)
